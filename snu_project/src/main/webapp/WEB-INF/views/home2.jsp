...
<body>
				...
				<div class="container-fluid">
					<div id="carousel-example-1" class="carousel slide"
						...
						<div class="carousel-inner row w-100 mx-auto" role="listbox">
							<div class="carousel-item col-6  col-xs-6 col-sm-6 col-md-4 col-lg-3 active">
								<div class="snu_info" style="border: 1px solid black; margin:auto; width:80%; height:250px;"></div>
							</div>
							<div class="carousel-item col-6  col-xs-6 col-sm-6 col-md-4 col-lg-3">
								<div class="snu_info" style="border: 1px solid black; margin:auto; width:80%; height:250px;"></div>
							</div>
							<div class="carousel-item col-6  col-xs-6 col-sm-6 col-md-4 col-lg-3">
								<div class="snu_info" style="border: 1px solid black; margin:auto; width:80%; height:250px;"></div>
						...
						<a class="carousel-control-prev" href="#carousel-example-1"
							role="button" data-slide="prev"> <i style ="color:black;"class="fas fa-angle-left"></i> <span
							class="sr-only">Previous</span>
						</a> <a class="carousel-control-next" href="#carousel-example-1"
							role="button" data-slide="next"> <i style ="color:black;"class="fas fa-angle-right"></i> <span
	...
	<script>
		...
		Carousel Images
		 */
		$('#carousel-example-1').on('slide.bs.carousel',
						function(e) {
							/*
